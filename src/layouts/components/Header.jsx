                      ...
                      notifications.map((notif) => (
                        ...
                        >
                          <div className="flex justify-between items-start mb-1">
                            <span
                              className={`text-sm font-semibold ${notif.unread ? "text-blue-700" : "text-gray-800"}`}
                            >
                              {notif.title}
                            </span>
              ...
              >
                <DialogContent className="sm:max-w-[425px]">
                  <DialogHeader>
                    ...
                    <DialogDescription>
                      Nhập mật khẩu hiện tại và mật khẩu mới để bảo mật tài
                      khoản.
                    </DialogDescription>
                  </DialogHeader>
