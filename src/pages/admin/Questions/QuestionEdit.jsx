          ...
          <div className="bg-white p-6 rounded-xl border border-gray-200 shadow-sm">
            ...
            <div className="space-y-5">
              <div>
                ...
                <Select value={questionData.subject} onValueChange={(value) => handleSelectChange("subject", value)}>
              ...
              <div>
                ...
                <Select value={questionData.difficulty} onValueChange={(value) => handleSelectChange("difficulty", value)}>
                  <SelectTrigger className="w-full outline-none focus:ring-2 focus:ring-blue-500">
              ...
              <div>
                ...
                <Select value={questionData.status} onValueChange={(value) => handleSelectChange("status", value)}>
                  <SelectTrigger className="w-full outline-none focus:ring-2 focus:ring-blue-500">
