...
const JourneySection = () => {
    const cardClass = "bg-white rounded-2xl p-8 shadow-sm hover:translate-y-[-5px] border-t border-t-4 hover:border-t-[#FF6B50] hover:border-t-4 transition-all border border-gray-100 flex flex-col items-start text-left group"
    return (
        <div className="py-16">
