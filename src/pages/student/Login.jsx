        ...
        <div className="min-h-screen w-full flex bg-white">
            ...
            <div className="w-full lg:w-1/2 flex items-center justify-center p-8 md:p-12 relative">
                ...
                <div className="w-full max-w-md space-y-8">
                    ...
                    <Button variant="outline" className="w-full h-12 font-medium text-gray-700 border-gray-200 hover:bg-gray-50 rounded-lg gap-2">
                    ...
                    <p className="text-center text-sm text-gray-500">
                        Chưa có tài khoản?{" "}
                        <Link to="/register" className="font-bold text-[#FF6B50] hover:underline">
                            Đăng ký ngay
                        </Link>
                    </p>
                </div>
